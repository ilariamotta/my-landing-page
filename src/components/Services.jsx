...
export default function Services() {
  ...
  return (
    <section className="relative bg-[var(--blackWarm)] text-white pt-0 pb-28">
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
          ...
          <div className="order-2 lg:order-1 lg:col-span-8">
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {services.map((s) => (
                <Card key={s.title} title={s.title} text={s.text} variant="dark" />
              ))}
            </div>

            <p className="mt-4 text-sm text-[var(--bgSoft)]/60 text-center italic">
              Se ti serve altro come restyling, UX/UI, revisione struttura e contenuti,
              possiamo parlarne lo stesso!
              <svg
          ...
          {/* RIGHT: title */}
          <div className="order-1 lg:order-2 lg:col-span-3 lg:col-start-10 lg:text-right">
